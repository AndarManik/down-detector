function buildNoPage(model) {
  ...
  <html lang="en">
    ...
    <body>
      ...
      <div id="content">
      <p style="background-color:#5ea797; color: #f4f9f8;">&nbsp;${model}&nbsp;</p>
        does not have a page yet.
        
      </div>
      <div style="display: flex;">
      <button id="dumbbutton">Request page?</button>
      </div>
    ...
    <script>
      ...
      document.getElementById("dumbbutton").addEventListener("click", function() {
          ...
          fetch("/request/newpage/" + encodeURIComponent(model));
      });
